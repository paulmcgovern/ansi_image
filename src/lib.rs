...
impl fmt::Display for ColorChar {
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        write!(f, "\u{1b}[{};2;{};{};{}m", mode_str, self.red, self.green, self.blue)
    }
}
...
pub fn get_char_for_area(img: &image::DynamicImage,
                         x_pos: u32,
                         y_pos: u32,
                         width: u32,
                         height: u32,
...
pub fn img_to_ansi(image_file: &str,
                   cons_w: u32, 
                   cons_h: u32, 
                   font_w_px: u32, 
                   font_h_px: u32,
                   out_char: &String,
                   mode: u8) -> Result<String, AnsiImageError> {
    ...
    let image = match image::open(image_file) {
        Ok(i) => i,
